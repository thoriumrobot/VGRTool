...
public class AddNullnessAnnotationsRefactoring extends Refactoring {
  ...
  public void apply(ASTNode node, ASTRewrite rewriter) {
    ...
    if (node instanceof VariableDeclarationStatement) {
      ...
      addNullableAnnotation(
          varStmt, rewriter, ast, VariableDeclarationStatement.MODIFIERS2_PROPERTY);
    }
  ...
  private void addNullableAnnotation(
      ASTNode node, ASTRewrite rewriter, AST ast, ChildListPropertyDescriptor modifiersProperty) {
